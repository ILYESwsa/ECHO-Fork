...
fun IntegrationScreen(
    ...
    val discordEnabled by rememberPreference(EnableDiscordRPCKey, false)
    val listenTogetherEnabled by rememberPreference(EnableListenTogetherKey, false)
        ...
        IntegrationCard(
            ...
            items = listOf(
                IntegrationCardItem(
                    ...
                    description = { Text(stringResource(R.string.discord_integration)) },
                    trailingContent = {
                        Switch(
                            checked = discordEnabled,
                            onCheckedChange = null, // read-only here; full settings on click
                        )
                    },
                    isHighlighted = discordEnabled,
        ...
        IntegrationCard(
            ...
            items = listOf(
                IntegrationCardItem(
                    ...
                    description = { Text("Listen to music in sync with friends") },
                    trailingContent = {
                        Switch(
                    ...
                    isHighlighted = listenTogetherEnabled,
